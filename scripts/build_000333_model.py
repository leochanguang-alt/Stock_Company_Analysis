#!/usr/bin/env python3
"""
Financial Valuation Model Generator — 000333.SZ 美的集团
...
YEARS = list(range(2016, 2026))   # 10 annual years: 2016-2025
...
print("=" * 60)
print("Fetching 000333.SZ annual financial data (2016-2025)...")
print("=" * 60)

# ── Income Statement ──
print("  [1/7] Income statement...")
inc_raw = pro.income(
    ts_code=TS_CODE, start_date='20160101', end_date='20251231',
    report_type='1',
...
for qd in quarters_to_try:
    try:
        df = ak.stock_gdfx_top_10_em(symbol=f'sz{TICKER_6}', date=qd)
        time.sleep(0.3)
...
doc_rows = [
    ...
    (9,  f'美的集团 is a diversified home-appliance and industrial-automation (KUKA) conglomerate.', False),
    (10, f'Segments: HVAC, consumer appliances, robotics & automation (KUKA), B2B industrial tech.', False),
    (11, f'Capital-intensive vs baijiu peers; ROIC 15-20% typical. Strong OCF + modest net debt.', False),
